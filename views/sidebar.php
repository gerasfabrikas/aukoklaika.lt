	...
	if(isset($_POST['code']) and (strtoupper($_POST["code"]) == $_SESSION['captcha'])) :
		if(isset($_POST['name']) and isset($_POST['elp']) and isset($_POST['desc'])) :
			if($_POST['name'] != '' and $_POST['elp'] !='' and $_POST['desc'] != '') :
                if(
                    sendEmailMessageToManagersOfCity($_POST['sav'], $_POST['name'].' ('.$citiesList[$_POST['sav']].') nori '.$_POST['nor'], $_POST['desc'], $from = $_POST['elp'], array('info@aukoklaika.lt'))
                    && sendEmailMessageToUserSelf($_POST['elp'], $from = 'info@aukoklaika.lt', array('info@aukoklaika.lt'))
                )
